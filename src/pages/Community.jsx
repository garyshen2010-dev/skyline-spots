...
import { getSpotBadges, spots } from "../data.js";
import "../App.css";
...
function Community() {
  ...
  const filteredSpots = allSpots
    .filter((spot) => {
      const searchText = `${spot.name} ${spot.city} ${spot.description} ${spot.type} ${spot.hiddenLevel} ${spot.tags.join(" ")} ${spot.submittedBy}`.toLowerCase();
      ...
      return (
        ...
        (typeFilter === "All" || spot.type === typeFilter)
      );
    })
    .sort((a, b) =>
      sortOption === "Most Upvoted"
        ...
        : sortOption === "Highest Rated"
          ...
          : sortOption === "Newest"
            ? allSpots.indexOf(a) - allSpots.indexOf(b)
            : 0
    );
      ...
      <section className="section community-page">
        ...
        <div className="filter-panel">
          {[
            ...
            ["Spot Type", spotTypes, typeFilter, setTypeFilter],
            [
              "Sort By",
